...
function mergeReaderHighlightRecords(
	...
	return {
		...
		chapterRootTitle: prior.chapterRootTitle || later.chapterRootTitle,
		chapterPath: prior.chapterPath?.length ? prior.chapterPath : later.chapterPath,
		chapterHref: prior.chapterHref || later.chapterHref,
		spineIndex: prior.spineIndex ?? later.spineIndex,
